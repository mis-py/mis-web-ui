...
const SettingsApp = () => {
  ...
  //     getSettingsUserId?.entities.forEach((item) => {
  ...
  return (
    <div className="flex flex-5 flex-row h-screen overflow-y-auto">
      <div className="flex items-center justify-between">
          <PageHeader pageHeader={["Administration", "App"]}/>
          <button
      ...
      <div className="flex flex-row h-screen overflow-y-auto p-2">
