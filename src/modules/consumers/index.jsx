...
const Consumers = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="-my-8 divide-y-2 divide-gray-100">
      ...
      <div className="py-8 flex flex-wrap md:flex-nowrap">
      <button className="flex mx-auto text-white bg-primary border-0 py-2 px-8 focus:outline-none rounded text-lg">Pause</button>
      <button className="flex mx-auto text-white bg-primary border-0 py-2 px-8 focus:outline-none rounded text-lg">Resume</button>
      </div>
    </div>
  </div>
</section>
